...
const Contact = () => {
  ...
  return (
    <div ref={ref} id='contact' className='   w-full justify-center items-center contact'>
        <div className='text-center items-center flex mx-auto w-full h-screen max-w-[1240px]'>
            <div className='grid grid-cols-4 md:grid-cols-4 w-full '>
                <div className='col-span-4 md:col-span-1 grid text-left justify-center items-center shadow-lg py-8 px-10 bg-white'>
                    <div className='py-4'>
                        <h2>Get in Touch!</h2>
                    </div>
                ...
                <div className='col-span-4 sm:col-span-3 justify-center text-center items-center mx-auto uppercase max-w-[1240px]'>
                    <motion.h1 animate={animation} className={contact ? 'text-center font-bold  cursor-pointer hidden supreme logoAnimate text-[60px]md:text-[150px] py-4'
                                : 'text-center font-bold text-[60px] cursor-pointer visible supreme logoAnimate md:text-[150px] py-4 '} 
